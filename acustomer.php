...
$username="root";
$password="";
$con=mysqli_connect($server,$username,$password,"Banking System");
if(!$con){
...
<div class="row">
    ...
    <div style="padding-top:2%;display:inline;"><h4 class="font-weight-bold" style="color:hsla(259, 44%, 23%, 0.686);font-size:2em;;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Customer Details</h4>
    </div>
        <br><br>
    ...
    <div class="col-sm" style="padding:1% 3%;">
        <div >
                    ...
                    <span class="font-weight-bold" style="color:hsla(259, 44%, 23%, 0.686);font-size:2em;line-height:1em;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Transcation Details</span>
                    </div><br><br>
                    <b style="font-size:1.2em;">Sender Name</b> : <span style="font-size:1.2em;"><input id="myinput" name="sender" disabled type="text" style="width:40%;border:none;" value='<?php echo "$user";?>'></input></span>

                        <br><br><br>
                        <b style="font-size:1.2em;">Reciever:</b>
                <select name="reciever" id="dropdown" required>
                    <option>Reciever Name</option>
                <?php
                $db = mysqli_connect("localhost", "root", "", "Banking System");
                ...
                <br><br><br>
                        <b style="font-size:1.2em;">Transcation Amount &#8377;:</b>
                        <input name="amount" type="number" style="width:35%;" min="100" required>
                        <br><br><br>
                        <button id="transfer"  name="transfer" class="btn btn-default" ><b>Approve Transaction</b></button>
                        </form>
        </div>
    </div>
</div>
